...
function moveCircle(circle){
    circle.x += circle.speedX; // Corrected assignment from circle.speedX to circle.x += circle.speedX
...
function bounceCircle(circle){
    ...
    if (circle.y < 0){
        circle.y -= circle.speedY; // Corrected assignment from circle.speedY to circle.y -= circle.speedY
        circle.speedY *= -1;
    }
